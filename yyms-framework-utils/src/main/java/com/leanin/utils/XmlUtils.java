...
//import com.leanin.domain.OutHosPatInfo;
//import com.leanin.domain.OutHosPatInfoAo;
...
public class XmlUtils {
    ...
    private static XStream createXstream() {
        ...
        XStream.setupDefaultSecurity(xstream);// XStream设置默认保护
//        xstream.allowTypes(new Class[]{OutHosPatInfoAo.class, OutHosPatInfo.class});
