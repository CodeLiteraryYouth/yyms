...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public DataOutResponse findUserList(int page,int pageSize,String adminName,String adminWorkNum) {
        log.info("用户工号为:"+adminWorkNum);
        PageHelper.startPage(page, pageSize);
        List<AdminUserDto> userList=userMapper.findUserList(adminName,adminWorkNum);
